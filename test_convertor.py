...
class TestFileMethods(unittest.TestCase): #inherit is implementing an is-a relationship: TestFileMethods is a TestCase class with extended behavior
    ...
    def test_str_to_ls(self):
        ...
        fl = file.File(y)
        fl.ls_to_str()
        self.assertEqual(fl.file_content, "Hi my name is Michael Konu.\nI am 23.")
    ...
    def test_insert(self):
        ...
        fl = file.File(x)
        fl.insert((0,2), "o")
        self.assertEqual(fl.file_content, ['Hio my name is Michael Konu.', 'I am 23.'])
...
class TestCurMethods(unittest.TestCase):
    ...
    def test_mv_left(self):
        ...
        cur.cur_pos = (1,0)  
        cur.mv_left()
        self.assertEqual(cur.cur_pos, (0,len(fl.file_content[0])))
        cur.cur_pos = (0, len(fl.file_content[0]))
        cur.mv_left()
        self.assertEqual(cur.cur_pos, (0, len(fl.file_content[0])-1))
        cur.cur_pos = (1,3)
        cur.mv_left()
    ...
    def test_mv_right(self):
        ...
        cur.cur_pos = (0,2)
        cur.mv_right()
        self.assertEqual(cur.cur_pos, (0,3))
        cur.cur_pos = (1,0)
        cur.mv_right()
